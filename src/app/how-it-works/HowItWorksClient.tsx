        ...
        <FadeUp delay={0.1}>
          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-0 items-stretch rounded-2xl overflow-hidden shadow-card border border-purple-100">
            ...
            <div className="px-9 py-10 flex flex-col" style={{ background: "#2D1B69" }}>
              <div className="flex items-center gap-2 mb-7">
                <div className="w-6 h-6 rounded-md flex items-center justify-center shrink-0" style={{ background: "rgba(255,255,255,0.12)" }}>
                  <Users size={13} className="text-white rtl:scale-x-[-1]" />
                </div>
            ...
            <div className="px-9 py-10 flex flex-col" style={{ background: "rgba(240,98,90,0.05)", borderLeft: "1px solid rgba(240,98,90,0.12)" }}>
              <div className="flex items-center gap-2 mb-7">
                <div className="w-6 h-6 rounded-md flex items-center justify-center shrink-0" style={{ background: "rgba(240,98,90,0.15)" }}>
                  <Zap size={13} className="rtl:scale-x-[-1]" style={{ color: "#F0625A" }} />
                </div>
