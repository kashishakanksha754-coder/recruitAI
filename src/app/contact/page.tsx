...
function WorldDotMap() {
  const DOT_GRID = [
    ...
    [38,11],[39,11],[40,11],[41,11],[42,11],[38,12],[39,12],[40,12],[41,12],
    [39,13],[40,13],[41,13],[40,14],[41,14],
    // Australia
    [41,16],[42,16],[43,16],[44,16],[45,16],
    [41,17],[42,17],[43,17],[44,17],[45,17],[46,17],
    [42,18],[43,18],[44,18],[45,18],[46,18],[43,19],[44,19],[45,19],[44,20],
  ] as [number, number][];
  ...
  return (
    ...
    >
      {DOT_GRID.map(([c, r], i) => (
        <circle key={i} cx={c * CELL + CELL / 2} cy={r * CELL + CELL / 2} r={1.8} fill="#D0CBF0" />
      ))}
      {PINS.map(([c, r, fill], i) => {
