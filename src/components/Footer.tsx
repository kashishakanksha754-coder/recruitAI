      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 pt-6 border-t border-purple-100 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex gap-5">
            <Link href="/privacy" className="text-muted/60 hover:text-muted text-xs transition-colors">Privacy</Link>
            <Link href="/terms" className="text-muted/60 hover:text-muted text-xs transition-colors">Terms</Link>
          </div>
        </div>
      </div>
    </footer>
