...
const badges = [
  { icon: FileText,    label: "Resume parsed",      color: "text-coral-500",  bg: "bg-coral-50",  top: "6%",  left: "8%"   },
  { icon: CheckCircle, label: "94% match score",    color: "text-purple-700", bg: "bg-purple-50", top: "28%", right: "4%"  },
  { icon: Phone,       label: "Call transcribed",   color: "text-coral-500",  bg: "bg-coral-50",  top: "50%", left: "4%"   },
  { icon: Star,        label: "Aria recommended",   color: "text-purple-700", bg: "bg-purple-50", top: "70%", right: "8%"  },
  { icon: Clock,       label: "Decision in 2 days", color: "text-coral-500",  bg: "bg-coral-50",  top: "86%", left: "28%"  },
];
